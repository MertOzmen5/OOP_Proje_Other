...
public class KahveDukkani extends KahveAbstract implements IMethodlar {
    ...
    public void MenuGetir() {
        ...
        do {
            ...
            System.out.println("1." + KahveTurleri.AMERICANO);
            ...
            switch (secim) {
                case 1:
                    System.out.println(KahveTurleri.AMERICANO + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 2:
                    System.out.println(KahveTurleri.ESPRESSO + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 3:
                    System.out.println(KahveTurleri.CAPPUCINO + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 4:
                    System.out.println(KahveTurleri.LATTE + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 5:
                    System.out.println(KahveTurleri.MOCHA + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 6:
                    System.out.println(KahveTurleri.MACCHIATO + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 7:
                    System.out.println(KahveTurleri.AFFOGATO + " seçtiniz");
                    KahveBoyutu();
                    sut();
                    break;
                case 8:
                    System.out.println(KahveTurleri.BUZLUKAHVE + " seçtiniz");
                    ...
                    break;
                case 9:
                    System.out.println(KahveTurleri.FRAPPUCCINO + " seçtiniz");
                    System.out.println("Sıcak bir yaz gününde,serinlemenin en iyi yolu,PERFECTO");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
                case 10:
                    System.out.println(KahveTurleri.IRISH + " seçtiniz");
                    KahveBoyutu();
                    seker();
                    sut();
                    break;
    ...
    public void KahveBoyutu() {
        ...
        switch (boyutSecimi) {
            case 1:
                System.out.println(KahveBoyutu.SMALL + " boyutunda kahveniz hazırlanıyor.");
                break;
            case 2:
                System.out.println(KahveBoyutu.MEDIUM + " boyutunda kahveniz hazırlanıyor.");
                break;
            case 3:
                System.out.println(KahveBoyutu.LARGE + " boyutunda kahveniz hazırlanıyor.");
                break;
            case 4:
                System.out.println(KahveBoyutu.XLARGE + " boyutunda kahveniz hazırlanıyor.");
                break;
            default:
                System.out.println("Geçersiz seçim,lütfen geçerli bir tuşlama yapınız.");
                break;
    ...
    public void seker() {
        while (true) {
            ...
            if (seker.equalsIgnoreCase("evet")) {
                ...
                System.out.println(kacSeker + " " + "şeker ekleniyor, lütfen bekleyin...");
                break;
    ...
    public void sut() {
        while (true) {
            ...
            if (sut.equalsIgnoreCase("evet")) {
                System.out.println("Süt ekleniyor, lütfen bekleyin...");
